...
| Launchpad seat chart | `rhpds/launchpad`, `deploy/workloads/agentops-seat`, at `3e2d3d2655400f9fc1de6577f76786ff1c24521a` | Namespace-scoped source with DNS-safe Route names and service-ca TLS for its pipeline database; the TLS revision awaits its clean one-seat rerun |
