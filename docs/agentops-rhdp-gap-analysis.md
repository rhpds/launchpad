...
| Launchpad seat chart | `rhpds/launchpad`, `deploy/workloads/agentops-seat`, at `fd7d53d23efbb72a27f2e21e325c5f6177f900d0` | Namespace-scoped source with DNS-safe Route names and service-ca TLS for its pipeline database; the TLS revision awaits its clean one-seat rerun |
