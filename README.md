...
| `multi-agent-quickstart` | Build Multi-Agent AI Systems with Open Protocols | One lab containing local, OpenShift, and advanced blueprint tracks; the shared runtime and OpenShift track are internally certified for one Arena seat, while optional advanced integrations, durable image supply, public access, and 5/25-seat gates remain |
