...
KNOWLEDGE_BASE = [
    ...
    {"id": "kb-008", "title": "LiteLLM Proxy Configuration", "content": "LiteLLM provides a unified OpenAI-compatible API gateway fronting multiple model backends. The platform routes through a LiteLLM proxy configured via environment variables. Per-tenant virtual keys enforce rate limits and model access. Models available: Granite, Llama, DeepSeek, Phi-4, Qwen, Nomic embeddings."},
